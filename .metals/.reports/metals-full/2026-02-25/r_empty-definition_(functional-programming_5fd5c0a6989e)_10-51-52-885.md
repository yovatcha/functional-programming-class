error id: file://<WORKSPACE>/src/level1/RSSProcess.scala:
file://<WORKSPACE>/src/level1/RSSProcess.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/xml.
	 -scala/Predef.scala.xml.
offset: 14
uri: file://<WORKSPACE>/src/level1/RSSProcess.scala
text:
```scala
import scala.x@@ml.XML
...
final class Level1Processor(val feeds: List[(String, String)]):
